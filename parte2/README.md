...
En los ejercicios 2 y 7 provocamos errores deliberados: intentamos reasignar un `val` e introducir un entero en un `Array[String]`. Conservamos las celdas y sus mensajes. Cuando se detiene la ejecución en uno de estos errores previstos, continuamos desde la celda siguiente.
...
| 15. Dos rondas | Integramos listas, arrays, funciones y bucles en Twenty-One. |
...
En el ejercicio 13 obtenemos los mismos resultados con while y foreach. El primero necesita un contador mutable; en el segundo pasamos una función que procesa cada mano.
